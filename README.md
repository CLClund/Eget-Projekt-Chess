...
The most challenging aspect of the project was implementing and verifying the rules of chess. Ensuring that each piece behaved correctly and that no invalid move could be made required more technical precision than initially expected. In particular, the implementation of check and checkmate proved to be especially complex.
